...
public class Prueba2 {
    ...
    private static void buscarProductos(Scanner scanner) {
    ...
    private static String enviarPeticionGet(String apiUrl) throws IOException {
        HttpURLConnection conexion = (HttpURLConnection) new URL(apiUrl).openConnection();
    ...
    private static void mostrarProductos(String json) {
    ...
    private static void mostrarProducto(String json) {
    ...
    private static void generarPDF(String contenido, String fechaHora) {
        try {
    ...
    private static void buscarPorNombreODescripcion(String json, String palabraClave) {
        String[] productos = json.substring(1, json.length() - 1).split("\\},\\{");
    ...
    private static void buscarPorRangoDePrecio(String json, double precioMinimo, double precioMaximo) {
        String[] productos = json.substring(1, json.length() - 1).split("\\},\\{");
        boolean encontrado = false;
        for (String producto : productos) {
    ...
    public static int sumaValores(int[] arregloEnteros) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'sumaValores'");
    }

    public static int valoresUnicos(Object[] arregloObjetos) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'valoresUnicos'");
    }
}
